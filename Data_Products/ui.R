...
shinyUI(
  pageWithSidebar(
    ...
    sidebarPanel(
      ...
      "color and clarity.  Please note that according to the",
      "model, for carat sizes between 1.495 and 1.915,",
       "clarity and color will impact the price.  For carat sizes",
      "between 0.995 and 1.495, clarity has an impact on price. Clarity, color,",
       "and cut do not impact the price for other carat sizes.")),
    mainPanel(
